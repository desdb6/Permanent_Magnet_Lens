...
\begin{figure}[H]
    ...
    \caption{Beeld van hematiet langs de $[001]$ as opgenomen met een TEM. \cite{VanAert2013}}
    \label{fig:TEM_image}
\end{figure}
...
\section{Opbouw en principe permanente magneetlens (Objectief 1)}
...
\section{Magnetische reluctantie van het circuit (Objectief 3)}\label{ch:reluctantie}
