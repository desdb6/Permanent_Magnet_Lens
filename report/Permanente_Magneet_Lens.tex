...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Foto's van de opstelling waarmee een uitvergroot beeld van een hexagonaal grid worden gevormd. De lens bevindt zich dichter bij de detector en er wordt gebruik gemaakt van een verlengstuk uit koperdraad om het raster dicht genoeg bij de lens te krijgen.}
\end{figure}
...
\end{enumerate}
Om dit te bereiken wordt de z-rail op zijn laagste positie gezet, en wordt de lens op een hogere stapel tussenringen geplaatst. Door de grotere afstanden tussen de componenten wordt er een hogere vergroting verwacht, dus wordt er gekozen voor een fijnmaziger raster met vierkante openingen van $\sim 55~\mu\mathrm{m}\times\sim 55~\mu\mathrm{m}$. Figuur \ref{fig:18.03.26_Grid_Measurements} toont een SEM beeld van een opening in dit raster. In dit experiment werd gebruik gemaakt van de MiniPIX detector vanwege een probleem met de werking van de AdvaPIX detector.\\
...
\begin{figure}[H]
    ...
    \label{fig:18.03.26_Grid_Measurements}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Herschaalde versie van Figuur \ref{fig:18.03.26_Grid} waarop meer rasteropeningen zichtbaar zijn. Er treedt een subtiel overlappend effect op waarbij er twee beelden over elkaar gevormd worden.}
