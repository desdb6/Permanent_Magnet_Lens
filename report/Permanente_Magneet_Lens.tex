...
Om de accuraatheid van de resultaten verkregen m.b.v. de simulatietoolbox te valideren, moet de focale lengte van de lens ook experimenteel bepaald worden. Om de focale lengte en eventueel andere lenseigenschappen van de lens te bepalen wordt er een aangepaste versie gebruikt van de \textit{rear mesh shadowgraph methode}, welke wordt beschreven in \cite{meshshadowgraphs}. Hieronder wordt deze werkwijze uitgelegd.

\subsection{Mesh shadowgraph methode}
Het algemene principe van deze methode bestaat er in om met behulp van de lens een bundel te convergeren in een punt, zodat er verder in de kolom een divergerende elektronenbundel ontstaat. De focale lengte kan dan worden afgeleid door te meten 'hoe divergent' deze elektronenbundel is. Concreet kan dit gemeten worden door een fijnmazig raster achter de afgebeeldde puntbron in de divergerende bundel te plaatsen, zodat er een uitvergroot schaduwbeeld op de detector wordt geworpen. De vergroting van het schaduwbeeld is dan een maat voor de divergentie van de elektronenbundel, waaruit de focale lengte afgeleid kan worden. Hieronder wordt dit verduidelijkt met behulp van illustraties.\\
