...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Images/MIRA_inside.png}
...
Figuur \ref{fig:MIRA_inside_1} toont een AdvaPIX-beeld genomen tijdens dit experiment. Op de weinige beelden waarbij de bundel op de detector terecht kwam, waren nauwelijks kenmerken van het rooster zichtbaar, enkel de centrale spot van de bundel is te herkennen.
...
\end{enumerate}
Om dit te bereiken wordt de z-rail op zijn laagste positie gezet, en wordt de lens op een hogere stapel tussenringen geplaatst.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{Images/18.03.26_Grid_Measurements.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Images/18.03.26_Grid.png}
    \caption{MiniPIX-beeld van de vierkante rasteropeningen. Dit geeft een veel beter beeld dan de voorgaande experimente, maar de distortie van het beeld is nog steeds groot. }
    \label{fig:18.03.26_Grid}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Images/18.03.26_Grid_Rescaled.png}
...
\subsection{Experimentele validatie focale lengte}
