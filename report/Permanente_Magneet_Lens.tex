...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{Images/f_ambiguity.png}
...
Met de analystische afschatting van het veld en de analytische afgeleiden zijn we in staat om de asymptotische aberratiecoëfficiënten in vergelijkingen \ref{eq:distortion} en \ref{eq:chr_ab} van de lens te berekenen. De uitdrukkingen van deze coëfficiënten worden hieronder gertoond \cite{PWHawkes}.
\begin{align}
