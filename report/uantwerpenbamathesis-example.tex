...
\begin{split}
    ...
    = &\frac{\mu_0\sigma_M\left(z+\frac{d}{2}\right)}{2}\left(\frac{1}{\sqrt{\left(z+\frac{d}{2}\right)^2+R_1^2}}-\frac{1}{\sqrt{\left(z+\frac{d}{2}\right)^2+R_2^2}}\right)\\
    & -\frac{\mu_0\sigma_M\left(z-\frac{d}{2}\right)}{2}\left(\frac{1}{\sqrt{\left(z-\frac{d}{2}\right)^2+R_1^2}}-\frac{1}{\sqrt{\left(z-\frac{d}{2}\right)^2+R_2^2}}\right)
\end{split}
\end{equation}
...
% \end{equation}
% De correctieterm geeft dus aan welke fractie van het magnetisch veld er overblijft wanneer we het demagnetiserend veld $H_d$ in rekening nemen. Het is meer gebruikelijk om dit uit te drukken als de interne permanentiecoëfficient $P_{ci}=\frac{B_m}{\mu_m H_d}$. Deze kunnen in dit specifiek geval uitrekenen:
% \begin{equation}
