...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{Images/variable_T.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.4\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Images/FreeCAD_3D_3.JPG}
        \caption{}
        \label{fig:FreeCAD_3D_3}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.4\linewidth}
        \centering
    ...
    \caption{Verschillende aanzichten van het ontwerp van de polepieces in FreeCAD.}
