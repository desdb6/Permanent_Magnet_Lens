...
Met de analystische afschatting van het veld en de analytische afgeleiden zijn we instaat om de asymtotische aberratiecoëfficiënten van de lens te berekenen. De uitdrukkingen van deze coëfficiënten worden hieronder gertoond \cite{PWHawkes}.
\begin{align}
    ...
    C_\theta&=\frac{\eta}{4\sqrt{V}}\int_{-\infty}^{+\infty}Bdz
\end{align}
